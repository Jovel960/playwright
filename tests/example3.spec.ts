...
test("TF 5 TC 1", async ({page}) => {
    console.log("TF 5 TC 1")
    await page.waitForTimeout(5000)
})

test("TF 5 TC 2", async ({page}) => {
    console.log("TF 5 TC 2")
    await page.waitForTimeout(5000)

})

test("TF 5 TC 3", async ({page}) => {
    console.log("TF 5 TC 3")
    await page.waitForTimeout(5000)

})

test("TF 5 TC 4", async ({page}) => {
    console.log("TF 5 TC 4")
    await page.waitForTimeout(5000)

})

test("TF 5 TC ", async ({page}) => {
    console.log("TF 5 TC 5")
    await page.waitForTimeout(5000)
